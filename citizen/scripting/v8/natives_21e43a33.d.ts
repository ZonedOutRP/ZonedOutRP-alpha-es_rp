...
declare function DrawMarker(type: number, x: number, y: number, z: number, dirX: number, dirY: number, dirZ: number, rotX: number, rotY: number, rotZ: number, scaleX: number, scaleY: number, scaleZ: number, colorR: number, colorG: number, colorB: number, alpha: number, bobUpAndDown: boolean, faceCamera: boolean, p19: number, rotate: boolean, textureDict: string, textureName: string, drawOnEnts: boolean): void;
...
declare function IsEntityTouchingEntity(from: number, to: number): number;
...
declare function N_0xb1bb03742917a5d6(type: number, x: number, y: number, z: number, p4: number, r: number, g: number, b: number, a: number): void;
...
declare function SetCloudHatTransition(type: string, ms: number): void;
...
declare function SetSirenWithNoDriver(vehicle: number, set: boolean): void;
