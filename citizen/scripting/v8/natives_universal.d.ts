 ...
 */
declare function AddShockingEventAtPosition(type: number, x: number, y: number, z: number, duration: number): number;

/**
 * duration is float here
 * Event types - camx.me/gtav/tasks/shockingevents.txt
 */
declare function AddShockingEventForEntity(type: number, entity: number, duration: number): number;
...
declare function BlockDecisionMakerEvent(name: string | number, type: number): void;
...
declare function ClearDecisionMakerEventResponse(name: string | number, type: number): void;
 ...
 * 180-189----------------Sphere (0-9)
 */
declare function CreateCheckpoint(type: number, posX1: number, posY1: number, posZ1: number, posX2: number, posY2: number, posZ2: number, radius: number, red: number, green: number, blue: number, alpha: number, reserved: number): number;
 ...
 * 5
 */
declare function DecorIsRegisteredAsType(propertyName: string, type: number): number;
...
declare function GetBitsInRange(var_: number, rangeStart: number, rangeEnd: number): number;
 ...
 */
declare function GetFirstParentIdForPedType(type: number): number;
 ...
 * Type equals 0 for male non-dlc, 1 for female non-dlc, 2 for male dlc, and 3 for female dlc.
 */
declare function GetNumParentPedsOfType(type: number): number;
 ...
 */
declare function GetStateOfClosestDoorOfType(type: string | number, x: number, y: number, z: number): [any /* actually bool */, number];
...
declare function IsEntityAttachedToEntity(from: number, to: number): number;
 ...
 */
declare function IsProjectileTypeInArea(x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, type: number, p7: boolean): number;
 ...
 */
declare function IsShockingEventInSphere(type: number, x: number, y: number, z: number, radius: number): number;
...
declare function IsStringNull(string: string): number;

declare function IsStringNullOrEmpty(string: string): number;
 ...
 */
declare function N_0x4645de9980999e93(p0: string, p1: string, p2: string, p3: string, type: string): number;
...
declare function N_0x648e7a5434af7969(p0: string, p2: boolean, type: string): [number, number, number, number, number];
...
declare function N_0x692d808c34a82143(p0: string, p1: number, type: string): number;
 ...
 */
declare function N_0x7b7723747ccb55b6(gamerTagId: number, string: string): void;
...
declare function N_0x9b2bd3773123ea2f(type: number, toggle: boolean): void;
 ...
 */
declare function N_0xb1bb03742917a5d6(type: number, xPos: number, yPos: number, zPos: number, p4: number, red: number, green: number, blue: number, alpha: number): void;
...
declare function N_0xc84527e235fca219(p0: string, p1: boolean, p2: string, type: string, p6: boolean): [number, number, number];
 ...
 */
declare function N_0xd202b92cbf1d816f(type: number, image: number, text: string): number;
 ...
 */
declare function N_0xdd6cb2cce7c2735c(type: number, button: string, text: string): number;
 ...
 */
declare function ScStartCheckStringTask(string: string, taskHandle: number): number;
/**
 * Starts a task to check an entered string for profanity on the ROS/Social Club services.
 * See also: 1753344C770358AE, 82E4A58BABC15AE7.
 */
declare function N_0x75632c5ecd7ed843(string: string, taskHandle: number): number;
...
declare function SetCloudHatTransition(type: string, transitionTime: number): void;
 ...
 */
declare function SetLoadingPromptTextEntry(string: string): void;
/**
 * Initializes the text entry for the the text next to a loading prompt. All natives for for building UI texts can be used here
 * e.g
 * void StartLoadingMessage(char *text, int spinnerType = 3)
 ...
 * "MP_SPINLOADING"                      = Loading
 */
declare function N_0xaba17d7ce615adbf(string: string): void;
...
declare function N_0xdea2b8283baa3944(gamerTagId: number, string: string): void;
 ...
 */
declare function SetStateOfClosestDoorOfType(type: string | number, x: number, y: number, z: number, locked: boolean, heading: number, p6: boolean): void;
...
declare function SetTaskVehicleChaseBehaviorFlag(ped: number, flag: number, set: boolean): void;
...
declare function ShowNumberOnBlip(blip: number, number: number): void;
 ...
 */
declare function StartPlayerSwitch(from: number, to: number, flags: number, switchType: number): void;
 ...
 */
declare function StringToInt(string: string, outInteger: number): number;

declare function SuppressAgitationEventsNextFrame(): void;

declare function SuppressShockingEventTypeNextFrame(type: number): void;
...
declare function UnblockDecisionMakerEvent(name: string | number, type: number): void;
